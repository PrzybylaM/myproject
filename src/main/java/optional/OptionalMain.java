...
public class OptionalMain {
    ...
    public static void main(String[] args) {
        ...
        Zamowieniee zamowienie = null;
        // łapanie wyjątku
        try
        {
            Optional<Zamowieniee> optionalZamowienie = Optional.of(zamowienie);
        ...
        Optional<Zamowieniee> optionalZamowienie = Optional.ofNullable(zamowienie);
