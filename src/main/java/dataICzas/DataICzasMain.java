...
public class DataICzasMain {
    ...
    public static void main(String[] args) {
      ...
      //          1. Napis daty   -
       //         2. FOrmat daty
        //        3. tworzymy formater, aby uzyć go do parsowania
        //          DateTimeFormatter formaterDaty;
      //          4. Używamy LocalDateTime.parse() i zamieniamy z użyciem formatu i datyNapis na
      //          dataObiekt czyli LocalDateTime
